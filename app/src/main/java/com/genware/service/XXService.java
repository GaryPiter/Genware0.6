...
import com.genware.activity.BaseActivity;
import com.genware.activity.LoginActivity;
import com.genware.activity.MainActivity;
import com.genware.activity.R;
import com.genware.activity.SendFileActivity;
import com.genware.activity.BaseActivity.BackPressHandler;
...
import com.genware.smack.SmackImpl;
...
public class XXService extends BaseService implements EventHandler, BackPressHandler {
	...
	public void sendMessage(String user, String message) {
		Log.i("mSmackable != null", (mSmackable != null) + "");
		if (mSmackable != null)
	...
	public void newMessage(final String from, final String message) {
		mMainHandler.post(new Runnable() {
			public void run() {
				Log.i("XXSer11111111", "接收消息"
						+ (!PreferenceUtils.getPrefBoolean(XXService.this, PreferenceConstants.SCLIENTNOTIFY, false)));
				...
				Log.i("XXService!isAppOnForeground()", (!isAppOnForeground()) + "");
				if (!isAppOnForeground())
					Log.i("XXSer+message", message);
	...
	public void updateServiceNotification(String message) {
		if (!PreferenceUtils.getPrefBoolean(this, PreferenceConstants.FOREGROUND, true))
			return;
		Log.i("XXService2222222222", "后台执行，通知栏消息");
